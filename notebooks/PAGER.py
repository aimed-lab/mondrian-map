...
class PAGER():
    ...
    def pathMember(self, PAG_IDs):
        ...
        # Work around PAGER API form encode issue.
        response = requests.post('https://discovery.informatics.uab.edu/PAGER/index.php/geneset/get_members_by_ids/', data=params)
        #print(response.request.body)
    ...
    def pagRankedGene(self, PAGid):
        response = requests.get('https://discovery.informatics.uab.edu/PAGER/index.php/genesinPAG/viewgenes/'+PAGid)
    ...
    def pagGeneInt(self, PAGid):
        response = requests.get('https://discovery.informatics.uab.edu/PAGER/index.php/pag_mol_mol_map/interactions/'+PAGid)
        return pd.DataFrame(response.json()['data'])
    
    # pagGeneReg is a function connected to PAGER api to retrieve gene regulatory network
    def pagGeneReg(self, PAGid):
        response = requests.get('https://discovery.informatics.uab.edu/PAGER/index.php/pag_mol_mol_map/regulations/'+PAGid)
        return pd.DataFrame(response.json()['data'])
    ...
    def path_NGSEA(SELF, genes, PAGmember):
        ...
        response = requests.post('https://discovery.informatics.uab.edu/PAGER/index.php/geneset/ngseaapi/', data=params)
        #print(response.request.body)
        return pd.DataFrame(response.json()['data'])
